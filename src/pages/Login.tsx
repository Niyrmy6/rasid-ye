    ...
    <div className="bg-background-light text-slate-800 min-h-screen flex flex-col font-display overflow-x-hidden selection:bg-primary selection:text-white">
      ...
      <main className="flex-1 flex flex-col w-full max-w-md mx-auto px-6 pb-8 relative z-10 justify-center">
        ...
        <div className="text-center mb-8">
          <h1 className="text-slate-800 text-3xl font-extrabold tracking-tight">تسجيل الدخول</h1>
          <p className="text-slate-500 mt-2 text-sm font-medium">مرحباً بك مجدداً في مجتمع راصد</p>
        </div>
        ...
        <form className="flex flex-col gap-5 w-full" onSubmit={handleSubmit}>
          <div className="space-y-2">
            ...
            <div className="relative">
              <input
                className="w-full bg-input-bg border-0 text-slate-800 text-right font-medium py-4 pr-12 pl-5 rounded-2xl focus:ring-2 focus:ring-primary/50 shadow-input transition-all placeholder:text-slate-400"
                dir="rtl"
                id="phone"
          ...
          <div className="space-y-2">
            ...
            <div className="relative">
              <input
                className="w-full bg-input-bg border-0 text-slate-800 text-right font-medium py-4 pr-12 pl-12 rounded-2xl focus:ring-2 focus:ring-primary/50 shadow-input transition-all placeholder:text-slate-400"
                dir="rtl"
                id="password"
                placeholder="••••••••"
                type="password"
