      ...
      <main className="flex-1 overflow-y-auto pb-32 max-w-md mx-auto w-full">
        <div className="p-4 space-y-6">
          ...
          <div className="bg-white dark:bg-surface-dark p-4 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-800">
            ...
            <div className="relative w-full h-40 bg-gray-200 dark:bg-gray-800 rounded-xl overflow-hidden group cursor-pointer">
              ...
              <div className="absolute inset-0 flex items-center justify-center bg-gray-100/50 dark:bg-gray-900/50">
                <span className="material-symbols-outlined text-4xl text-primary drop-shadow-md animate-bounce">
                  location_on
                </span>
              </div>
            </div>
          ...
          <div className="bg-white dark:bg-surface-dark p-4 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-800">
            ...
            <div className="grid grid-cols-2 gap-4 mb-4">
              <div>
                ...
                <select className="w-full px-3 py-2 bg-gray-50 dark:bg-white/5 border border-gray-200 dark:border-gray-700 rounded-xl focus:ring-2 focus:ring-primary focus:border-primary outline-none text-sm appearance-none cursor-pointer">
