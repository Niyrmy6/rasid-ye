  ...
  return (
    <div className="bg-background-light dark:bg-background-dark text-text-main dark:text-slate-100 antialiased selection:bg-primary selection:text-white h-screen flex flex-col overflow-hidden">
      <header className="sticky top-0 z-40 bg-background-light/95 dark:bg-background-dark/95 backdrop-blur-sm px-4 py-3 flex items-center justify-between shadow-sm max-w-md mx-auto w-full">
        ...
        <h1 className="text-lg font-bold text-text-main dark:text-slate-100">الخريطة</h1>
      </header>
      ...
      <div className="max-w-md mx-auto w-full flex-1 flex flex-col relative">
        <div className="px-4 py-3 z-30 bg-background-light dark:bg-background-dark border-b border-gray-100 dark:border-white/5">
          ...
          <div className="relative w-full">
            <label className="block text-xs font-medium text-text-muted mb-1 px-1">التاريخ</label>
            <div className="relative">
              <input 
                type="date" 
                value={selectedDate}
              ...
              />
              <div className="block w-full rounded-xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-surface-dark py-2.5 px-3 text-text-main dark:text-slate-100 flex items-center justify-between shadow-sm hover:border-primary/50 transition-colors pointer-events-none">
                <span className="text-sm">{selectedDate ? selectedDate : 'أكتوبر ٢٠٢٣ - نوفمبر ٢٠٢٣'}</span>
        ...
        <main className="flex-1 relative w-full h-full bg-[#eefcfc] dark:bg-black/20 overflow-hidden pb-24">
          <div className="map-container flex items-center justify-center p-4 relative w-full h-full">
            ...
            >
              <path d="M450,150 Q600,100 700,180 L750,250 Q650,350 500,300 Z" fill="#fff9c4"></path>
              <path d="M700,180 L780,190 L790,280 L750,250 Z" fill="#fffde7"></path>
              <path
                d="M400,250 Q450,200 500,300 L450,380 Q350,350 400,250 Z"
                fill="#ffcc80"
              ></path>
              <path d="M350,180 Q400,150 450,200 L400,250 L320,220 Z" fill="#ffab91"></path>
              <path d="M280,200 Q320,180 350,210 L320,260 L280,240 Z" fill="#ef5350"></path>
              ...
              <path d="M270,160 Q300,150 320,180 L280,200 L260,180 Z" fill="#ffb74d"></path>
              <path d="M220,160 Q250,140 270,160 L260,220 L210,200 Z" fill="#ef5350"></path>
              <path d="M200,200 L210,250 L230,320 L190,300 L180,220 Z" fill="#e53935"></path>
              <path d="M230,320 L260,350 L240,380 L200,360 Z" fill="#b71c1c"></path>
              <path d="M260,280 L280,310 L260,330 L240,300 Z" fill="#d32f2f"></path>
              <path d="M280,240 L320,260 L300,300 L260,280 Z" fill="#ff7043"></path>
              <path d="M320,260 L400,250 L380,320 L300,300 Z" fill="#ffcc80"></path>
              <path d="M280,380 L300,390 L290,410 L270,400 Z" fill="#e53935"></path>
              <path d="M260,350 L320,340 L300,390 L280,380 Z" fill="#ffe082"></path>
              <path d="M320,340 L380,320 L400,380 L320,390 Z" fill="#fff59d"></path>
              <path d="M250,100 Q300,90 330,140 L270,160 L220,130 Z" fill="#ff8a65"></path>
              <path d="M330,140 Q450,100 500,160 L450,200 L350,180 Z" fill="#fff176"></path>
            </svg>
            ...
            >
              ...
              <div
                className="absolute -bottom-1.5 left-1/2 -translate-x-1/2 w-0 h-0 border-l-[6px] border-l-transparent border-r-[6px] border-r-transparent border-t-[6px] border-t-[#1f2b28]/95"
              ></div>
            </div>
